...
CleverTabs.prototype.add = function (options) {
	...
	var tabico='<img src="context/themes/base/images/'+options.prop+'.gif" border="0">';//Tab图标
    ...
    .replace(/#\{label\}/g, function () {
        //如果Tab的Label大于10个字符，则强制使其为前7个字符加'...'
        if (options.label.length > 10) {
            //return tabico+options.label.substring(0, 10) + '...';
        }
		
        return tabico+options.label;
    } ()));
